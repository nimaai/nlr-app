...
},{"./update":2,"bootstrap":3,"jquery":16,"scrollup/dist/jquery.scrollUp.min.js":34}],2:[function(require,module,exports){
(function (global){
'use strict';
...
},{"nlr":33}],3:[function(require,module,exports){
...
onDeviceReady = function() {
  return $('#fb-link').on('click', function(event) {
    event.preventDefault();
    return window.open('https://facebook.com/nlreminder', '_system', 'location=yes');
  });
};
